...
export class HomePageComponent {
  ...
  ;
  defaultResumo: string = `Meu nome é Caio Marques, um desenvolvedor web de 21 anos do Rio de Janeiro, Brasil, e este site é o
  ...
  sempre buscando reconhecer e expandir meus limites através da autoeducação e autodidatismo.` 
